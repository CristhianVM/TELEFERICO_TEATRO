                            ...
                            <form className="text-start mt-4">
                                <div className="grid grid-cols-1">
                                    ...
                                    <div className="flex justify-between mb-4">
                                        ...
                                        <p className="text-slate-400 mb-0"><Link href="/home/kazuto/Desktop/SENIOR/LARAVEL/teleferico_teatro/resources/js/pages/reset-password" className="text-slate-400">Forgot password ?</Link></p>
                                    </div>
                                    ...
                                    <div className="text-center">
                                        <span className="text-slate-400 me-2">Don't have an account ?</span> <Link href="/home/kazuto/Desktop/SENIOR/LARAVEL/teleferico_teatro/resources/js/pages/signup" className="text-slate-900 dark:text-white font-bold inline-block">Sign Up</Link>
                                    </div>
                                </div>
                            </form>
                        </div>
